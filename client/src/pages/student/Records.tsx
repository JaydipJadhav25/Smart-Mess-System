...
function Records() {
  ...
  const [loadingTranscation, setLoadingTranscation] = useState<boolean>(false);
  //admin settings get
  ...
  const studentFeePaidMonth: string[] =
    data?.map((ele: any) => {
      if (ele.status === "paid") {
        return ele.month;
      }
  ...
  async function createOrder(month: string) {
    try {
      ...
      //also check admission in messa
      // if (!isFormSubmitted) return;

      if (!confirm("Proceed with payment of ₹3,300?")) return;
      setLoadingTranscation(true);
      const orderRes = await axiosInstance.post("/user/payment/create-order", {
        student_id,
        month,
      });
      ...
      const options = {
        ...
        handler: async (response: any) => {
          ...
          if (verifyRes.data.success) {
            ...
            //status
            navigation("/transcation-success");
          }
        },
      };
  ...
  return (
    <StudentLayout currentPage="records">
      ...
      {localStorage.getItem("applicationSubmit") !== "true" && (
        <div className="flex flex-col items-center justify-center p-8 bg-amber-50 border border-amber-200 rounded-xl shadow-sm max-w-lg mx-auto">
          ...
          <p className="text-sm text-gray-600 text-center leading-relaxed mb-6">
            This feature is exclusively available to registered mess members. It
            appears you haven't submitted your admission application yet.
          </p>
      ...
      {/* loadin */}
      {loadingTranscation && (
        <div className="flex flex-col items-center justify-center p-8 bg-gray-50 border border-gray-200 rounded-xl shadow-sm max-w-lg mx-auto">
          ...
          <p className="text-sm text-gray-600 text-center leading-relaxed">
            Your payment is currently being verified on the network. Please stay
            on this page while we confirm the transaction with the blockchain
            ledger.
          </p>

          <div className="mt-4 px-3 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full uppercase tracking-wider">
          ...
          <TabsContent value="feePay" className="mt-6">
            ...
            dark:bg-yellow-900/30 dark:text-yellow-400"
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    {/* Pay Button */}
                    <button
                      hidden={loadingTranscation || localStorage.getItem("applicationSubmit") !== "true"}
                          ...
                          <div className="mt-3 space-y-1 text-xs text-gray-300">
                           ...
                           underline underline-offset-2"
                            ...
                            <p className="mt-2 text-[11px] text-gray-400 italic">
                              This record is permanently stored on the Ethereum
