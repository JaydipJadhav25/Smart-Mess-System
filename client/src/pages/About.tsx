...
export default function About() {
          ...
          <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-lg max-w-xl mx-auto md:mx-0 opacity-90">
                ...
                into a seamless, automated, and transparent experience.  
                Our system centralizes operations, ensures accuracy in attendance and meal tracking, 
                and provides authentic feedback channels for students and administrators alike.
              </p>
            </div>
  ...
  <div
    className="relative mx-auto w-full h-[400px] sm:h-[500px] md:h-[600px]"
  >
    <CircularGallery
      bend={3}
      textColor="#3949AB"
...
<section className="container mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
  ...
  <div>
    ...
    <p className="text-lg leading-relaxed text-gray-200">
      ...
      <span className="font-semibold"> AI-powered meal demand prediction</span>, 
  ...
  <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
    ...
    <div>
      ...
      <ul className="space-y-4">
        ...
        <li className="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m6 4h6m-3-3v6m-6 4h6m-3-3v6" />
          </svg>
          <span>Phone: +91 12345 67890</span>
        </li>
        <li className="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 12l4.243-4.243M6.343 7.343L10.586 12l-4.243 4.243" />
          </svg>
