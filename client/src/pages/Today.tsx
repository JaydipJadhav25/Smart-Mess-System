...
const today = data.find(
  ...
  const dummyImages = {
    ...
    lunch:
      "https://images.unsplash.com/photo-1600891964330-33c5e1c5d4b2?auto=format&fit=crop&w=400&q=80",
    dinner:
      "https://images.unsplash.com/photo-1600891964182-611d9f86392d?auto=format&fit=crop&w=400&q=80",
  };
                  ...
                  {meals &&
                    meals.map((meal) => {
                      ...
                      return (
                        <Card
                          key={meal.name}
                          className="shadow-lg hover:shadow-2xl transition bg-background border-2"
                        >
                          <CardHeader>
