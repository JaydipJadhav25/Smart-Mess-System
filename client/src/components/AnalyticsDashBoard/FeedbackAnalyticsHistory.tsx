...
const FeedbackAnalyticsHistory: React.FC<{
  ...
  const summaryLineData = useMemo(
    () => [
      ...
      {
        name: "Avg Rating (x100)",
        value: analysisData.summary.averageRating * 100,
      },
    ],
    [analysisData],
  );
  ...
  const totalFeedbacks =
    analysisData.positiveFeedbacks.count + analysisData.negativeFeedbacks.count;
  const positivePieData = [
    { name: "Positive", value: analysisData.positiveFeedbacks.count },
    {
      name: "Remaining",
      value: totalFeedbacks - analysisData.positiveFeedbacks.count,
    },
  ];
  const negativePieData = [
    ...
    {
      name: "Remaining",
      value: totalFeedbacks - analysisData.negativeFeedbacks.count,
    },
  ];
  ...
  const spammersPieData = [
    ...
    {
      name: "Regular Users",
      value: totalFeedbacks - analysisData.spammingUsers.count,
    },
  ];
  ...
  const ratingDistributionData = useMemo(
    () =>
      Object.entries(analysisData.sentimentDistribution).map(
        ([key, value]) => ({
          name: `${key.split("_")[0]} ★`,
          count: value,
        }),
  ...
  return (
    <div className="border border-gray-200 rounded-xl p-5 bg-gray-50 shadow-sm hover:shadow-md transition-all">
      ...
      {open && (
        <div className="container dark:bg-background dark:text-white mx-auto px-4 sm:px-6 lg:px-8 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="text-center">
                    <div className="bg-blue-50 p-8 rounded-2xl">
                      ...
                      <h3 className="text-3xl font-bold text-gray-900">
                        {analysisData.summary.totalFeedbacks}
                      </h3>
                  ...
                  <div className="text-center">
                    <div className="bg-yellow-50 p-8 rounded-2xl">
                      ...
                      <h3 className="text-3xl font-bold text-gray-900">
                        {analysisData.summary.averageRating.toFixed(2)}
                      </h3>
                      <p className="text-gray-600 font-semibold">
                        Average Rating / 5.0
                      </p>
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        />
              ...
              <section className="bg-background/80 p-6 rounded-3xl shadow-xl border">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6 flex items-center gap-3">
                  <FiTrendingUp className="text-green-600" /> Feedback
                  Distribution Analysis
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-700 dark:text-orange-400 mb-4 text-center">
                      Positive Feedbacks
                    </h3>
                    ...
                    <div className="text-center mt-4">
                      <span className="text-2xl font-bold text-green-600">
                        {analysisData.positiveFeedbacks.count}
                      </span>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-700 dark:text-red-400 mb-4 text-center">
                      Negative Feedbacks
                    </h3>
                    <ResponsiveContainer width="100%" height={300}>
                      <PieChart>
                    ...
                    <div className="text-center mt-4">
                      <span className="text-2xl font-bold text-red-600">
                        {analysisData.negativeFeedbacks.count}
                      </span>
                      <span className="text-gray-500 ml-2">
                        out of {totalFeedbacks}
                      </span>
              ...
              <section className="bg-background/80 p-6 rounded-3xl shadow-xl border">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
                  <FiShield className="text-orange-600" /> Spam Detection
                  Analysis
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="text-center mt-4">
                      <span className="text-2xl font-bold text-orange-600">
                        {analysisData.spammingUsers.count}
                      </span>
                      <span className="text-gray-500 ml-2">
                    ...
                    <div className="bg-orange-50 p-4 rounded-2xl max-h-80 overflow-y-auto">
                      {showSpammersList ? (
                        <div className="space-y-2">
                          {analysisData.spammingUsers.list.map(
                            (user: any, index: any) => (
                              <div
                                key={index}
                                className="bg-white p-3 rounded-lg shadow-sm border border-orange-200"
                              >
                        ...
                        <div className="text-center py-8">
                          ...
                          >
                            View Flagged Users (
                            {analysisData.spammingUsers.list.length})
                          </button>
                        </div>
                      )}
                    </div>
              ...
              <section className="bg-background/80 p-6 rounded-3xl shadow-xl border">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
                  <FiStar className="text-purple-600" /> Rating Distribution
                  Analysis
                </h2>
              ...
              <section className="bg-background/80 p-6 rounded-3xl shadow-xl border">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
                  <FiTrendingUp className="text-green-600" /> Top Performing
                  Meals
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {analysisData.mostPositiveMeals.meals.map(
                    (meal: any, index: any) => (
                      <div
                        key={index}
              ...
              <section className="bg-background/80 p-6 rounded-3xl shadow-xl border">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
                  <FiTrendingDown className="text-red-600" /> Meals Needing
                  Improvement
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {analysisData.mostNegativeMeals.meals.map(
                    (meal: any, index: any) => (
                      <div
                        key={index}
                      ...
                      >
                        ...
                        {meal.negativeComments &&
                          meal.negativeComments.length > 0 && (
                            <div className="mt-4">
                              <h4 className="font-semibold text-gray-700 mb-2 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="bg-green-50 p-6 rounded-2xl border border-green-200">
                    ...
                    <div className="space-y-3">
                      {analysisData.aiSuggestions.goodPoints.map(
                  ...
                  <div className="bg-red-50 p-6 rounded-2xl border border-red-200">
                    ...
                    <div className="space-y-3">
                      {analysisData.aiSuggestions.badPoints.map(
                        (point: any, index: number) => (
                          <div
                            key={index}
              ...
              <section className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-3xl shadow-xl border">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border">
                  ...
                  <div className="mt-6 flex items-center gap-4 text-sm text-gray-500">
                    ...
                    <span>•</span>
                    <span>
                      Based on {analysisData.summary.totalFeedbacks} feedback
                      entries
                    </span>
                  </div>
                </div>
...
export default FeedbackAnalyticsHistory;
